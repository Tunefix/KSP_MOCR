...
namespace KSP_MOCR
{
	public partial class Form1 : Form
	{
		...
		private void Form1_Load(object sender, EventArgs e)
		{
			...
			font = CreateFont(AppDomain.CurrentDomain.BaseDirectory + "/consola.ttf", 12, FontStyle.Regular);
			buttonFont = CreateFont(AppDomain.CurrentDomain.BaseDirectory + "/consola.ttf", 8, FontStyle.Regular);
